...
#' @param x data frame
#' @param debug set `TRUE` by defult to report sf type to be built
#'
#' @return sf data frame
#' @export
#' @importFrom sfheaders sf_mpoly sf_mline sf_poly sf_line sf_mpt sf_pt sf_to_df
#' @export sf_mpoly sf_mline sf_poly sf_line sf_mpt sf_pt sf_to_df
#' @aliases sf_mpoly sf_mline sf_poly sf_line sf_mpt sf_pt sf_to_df
#' @examples
#' df <- data.frame(
